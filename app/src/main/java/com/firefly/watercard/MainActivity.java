...
public class MainActivity extends Activity {
    ...
    private static final byte[][] COMMON_AIDS = {
            ...
            new byte[]{0xA0, 0x00, 0x00, 0x03, 0x06, 0x00},
            new byte[]{0xA0, 0x00, 0x00, 0x02, 0x01, 0x01},
    ...
    private void readCardFiles(IsoDep isoDep, StringBuilder output) throws IOException {
        ...
        byte[][] cmds = {
                ...
                new byte[]{0x00, (byte) 0xB2, 0x01, 0xD0, 0x00},
                new byte[]{0x00, (byte) 0xB2, 0x02, 0xD0, 0x00},
